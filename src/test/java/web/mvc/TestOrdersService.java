...
@Test
	public void insert() {
		//멤버회원
		for(int i=1; i<=9; i++) {
		userRep.save(new Users("users"+i, "1111", "010-1234-123"+i, "users"+i+"@naver.com", "users"+i, 1, null));
		}
		
		//일반회원
		for(int i=11; i<=30; i++) {
			userRep.save(new Users("users"+i, "1111", "010-1234-12"+i, "users"+i+"@naver.com", "users"+i, 0, null));
		}
	}
